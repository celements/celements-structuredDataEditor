...
public class TextAreaFieldEditorClass extends AbstractClassDefinition implements StructEditorClass {
  ...
  public static final ClassField<Integer> TEXTAREA_FIELD_ROWS = new IntField.Builder(CLASS_DEF_HINT,
      "textarea_field_rows").prettyName("Rows").build();
  public static final ClassField<Integer> TEXTAREA_FIELD_COLS = new IntField.Builder(CLASS_DEF_HINT,
      "textarea_field_cols").prettyName("Columns").build();
  public static final ClassField<String> TEXTAREA_FIELD_VALUE = new LargeStringField.Builder(
